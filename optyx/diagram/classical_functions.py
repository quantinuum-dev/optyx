...
This module defines classical control
primitives used in hybrid quantum-classical
circuits.

Classical control is defined using callable boxes that act on classical types
(:class:`Bit` or :class:`Mode`) via
user-defined logic or matrix transformations.
...
from optyx.diagram.channel import Channel, CQMap, Ob, Ty
from optyx.diagram.optyx import Box, Bit, Diagram, Mode, MAX_DIM
